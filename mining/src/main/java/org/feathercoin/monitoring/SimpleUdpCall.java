...
class SimpleUdpCall
{
    ...
    public SimpleUdpCall(String command, String _ip, String _port) throws Exception
    {
        InetAddress ip;
        int port;
    ...
    {
        String command = "{\"command\":\"coin\"}";
        String ip = "192.168.188.40";
        String port = "4028";
        ...
        new SimpleUdpCall(command, ip, port);
    }
}